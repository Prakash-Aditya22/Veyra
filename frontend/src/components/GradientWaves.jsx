...
const GradientWaves = ({
  ...
  useEffect(() => {
    ...
    // The first frame renders synchronously during mount, before this effect
    // has set real colors, and ogl caches that white value per-uniform. A
    // forced render here guarantees a colored frame lands immediately
    // instead of waiting on the next animation-frame/observer callback.
